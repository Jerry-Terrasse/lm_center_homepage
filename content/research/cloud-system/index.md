  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        Yuhang Li, Rong Gu*, Chengying Huan, Zhibin Wang, Renjie Yao, Chen Tian, Guihai Chen. HotPrefix: Hotness-Aware KV Cache Scheduling for Efficient Prefix Sharing in LLM Inference Systems. The 52th ACM SIGMOD/PODS International Conference on Management of Data (SIGMOD, CCF-A), 2026, accepted, to appear. （南京大学是独立完成单位）
